      ...
      <div class="help-content">
        ...
        <div class="section">
          ...
          <ol>
            <li>
              <strong>添加新卡：</strong>
              <p>点击控制中心里的“新增信用卡”，填写国家、银行、卡号、有效期、额度、币种、账单日、还款日、年费和备注等信息。</p>
              <ul>
                <li>卡号和 CVV 支持掩码显示，点击眼睛图标可临时查看。</li>
                <li>有效期使用 MM/YY 格式保存。</li>
                <li>同银行共享额度默认开启，修改共享额度卡会同步同地区同银行的共享额度信息。</li>
                <li>账单日消费可设置计入当期账单或下期账单，用于免息期计算。</li>
              </ul>
            </li>
            <li>
        ...
        <div class="section">
          <h3>搜索和筛选</h3>
          <ul>
            <li>顶部“任意内容检索”会搜索别名、银行、卡号、等级、币种、国家、权益、备注和额度。</li>
            <li>点击“展开筛选”可使用高级筛选，按国家、银行、卡号、等级、额度、年费状态、权益和备注过滤。</li>
          ...
          <ul>
            ...
            <li>卡号和 CVV 默认掩码显示，导出和云端备份默认加密。</li>
          ...
          <ul>
            <li><strong>导出数据：</strong>
              <p>在“更多 -> 导出数据”中可复制或下载加密数据。</p>
              <ul>
                <li>支持默认加密和自定义密码加密。</li>
                <li>开发环境会额外显示明文导出和隐私明文导出按钮，正式使用时不会显示。</li>
              </ul>
            </li>
            <li><strong>导入数据：</strong>
              <p>在“更多 -> 导入数据”中可选择文件或粘贴数据。</p>
              <ul>
                <li>自定义密码加密的数据需要输入导出时设置的密码。</li>
                <li>导入后会自动执行数据结构迁移，并同步到当前本地数据和云同步账本。</li>
              </ul>
            </li>
            <li><strong>云端备份和同步：</strong>
              <p>“云端备份”和“云同步设置”使用 WebDAV 存储。</p>
              <ul>
                <li>“更多 -> 云同步设置”配置协议、地址、端口、路径、账号和密码，保存后会重新启动云同步状态检测。</li>
                <li>顶部状态胶囊展示同步状态、最近更新时间和下次自动同步倒计时。</li>
                <li>“立即同步”会发布当前本地数据到云端同步快照。</li>
                <li>“云端备份”支持创建加密备份、比对、恢复/融合、重命名和删除备份文件。</li>
                <li>首次进入时会检查最新云端备份，发现差异会提示预览或融合。</li>
              </ul>
            </li>
            <li><strong>本地备份：</strong>
              <p>“更多 -> 本机备份”用于查看和恢复浏览器本地备份。</p>
              <ul>
                <li>数据变更后 1 分钟自动创建本地备份。</li>
                <li>最多保留最近 50 条备份记录。</li>
                <li>“预览”会展示备份与当前数据的新增、删除、修改差异。</li>
                <li>“恢复”会用所选备份覆盖当前数据，并进入云同步保存流程。</li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div class="section">
          <h3>年费管理</h3>
          <ul>
            <li>“年费提醒”会检查未达标、60 天内即将收取、以及已过期 60 天内的年费卡片。</li>
          ...
          <ul>
            ...
            <li>支持批量删除、导出选中项、标记达标、标记未达标、批量更新年费、批量更新有效期。</li>
            <li>批量更新会刷新卡片的最后修改时间，并通过统一同步流程保存。</li>
          </ul>

          <h3>免息期计算</h3>
          <ul>
            <li>需要设置账单日和还款日后才会显示免息期。</li>
            <li>系统会根据当前日期、账单日、还款日和“账单日消费计入”设置自动计算。</li>
          </ul>

          <h3>统计分析</h3>
          <ul>
            <li>“统计分析”可查看总额度、卡片数量、共享额度、独立额度、银行分布、等级分布、有效期和年费状态。</li>
            <li>统计页支持导出统计数据。</li>
          </ul>

          <h3>个性化设置</h3>
          <ul>
            <li>“更多 -> 自定义列”可选择表格中显示的字段，支持全选、取消全选和恢复默认。</li>
        ...
        <div class="section">
          ...
          <ul>
            <li><strong>键盘快捷键：</strong>
              ...
              <ul>
                ...
                <li><kbd>Ctrl+Shift+B</kbd> - 本机备份</li>
            ...
            <li><strong>数据备份建议：</strong>
              <ul>
                <li>重要修改后优先点击“立即同步”或创建云端备份。</li>
                <li>定期导出加密数据，妥善保存自定义导出密码。</li>
                <li>恢复云端或本机备份前，先使用“比对/预览”确认差异。</li>
              </ul>
            </li>
          </ul>
          ...
          <h3>移动端优化</h3>
          <ul>
            <li>小屏幕下“云端备份”“统计分析”“年费提醒”等常用入口会收纳到“更多”菜单中。</li>
            <li>表格会隐藏部分低优先级字段，弹窗会适配移动端宽度。</li>
        ...
        <div class="section">
          <h3>WebDAV 同步</h3>
          <p>系统支持通过 WebDAV 做云同步和云端备份。配置完成后，可通过顶部“立即同步”发布当前数据，也可以进入“云端备份”管理历史备份。</p>
