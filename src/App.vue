  ...
  computed: {
    ...
    tableData() {
      ...
      return this.cardData.filter(item => {
        ...
        if (this.formSearch.bank == '' && this.formSearch.country == '' && this.formSearch.type == '' && this.formSearch.cardNumber == '' && this.formSearch.level == '' && this.formSearch.limit == '' && this.formSearch.cvv == '' && this.formSearch.valid == '' && this.formSearch.annualFee == '' && this.formSearch.nextAnnualFeeCollectionTime == '' && this.formSearch.equity == '' && this.formSearch.remark == '' && this.formSearch.lastTime == '') {
          return true;
        } else {
