...
# ==============================================================================
# Android 原生信用卡管理客户端 ── Release 自动打包脚本
# ==============================================================================
...
echo -e "${YELLOW}====================================================${NC}"
echo -e "${YELLOW}🚀 开始执行 Android 原生信用卡客户端 Release 自动打包${NC}"
echo -e "${YELLOW}====================================================${NC}"
...
if [ -f "$APK_PATH" ]; then
    ...
    echo -e "${GREEN}👉 默认包: [CreditCard-Release.apk](${PWD}/releases/CreditCard-Release.apk)${NC}"
